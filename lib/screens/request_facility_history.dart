...
import 'package:miel_work_web/screens/request_facility_history_source.dart';
...
class RequestFacilityHistoryScreen extends StatefulWidget {
  final LoginProvider loginProvider;
  final HomeProvider homeProvider;

  const RequestFacilityHistoryScreen({
  ...
  @override
  State<RequestFacilityHistoryScreen> createState() =>
      _RequestFacilityHistoryScreenState();
}

class _RequestFacilityHistoryScreenState
    extends State<RequestFacilityHistoryScreen> {
              ...
              child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return CustomDataGrid(
                    source: RequestFacilityHistorySource(
                      context: context,
