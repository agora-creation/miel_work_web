...
import 'package:miel_work_web/screens/request_cycle_history_source.dart';
...
class RequestCycleHistoryScreen extends StatefulWidget {
  final LoginProvider loginProvider;
  final HomeProvider homeProvider;

  const RequestCycleHistoryScreen({
  ...
  @override
  State<RequestCycleHistoryScreen> createState() =>
      _RequestCycleHistoryScreenState();
}

class _RequestCycleHistoryScreenState extends State<RequestCycleHistoryScreen> {
              ...
              child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return CustomDataGrid(
                    source: RequestCycleHistorySource(
                      context: context,
                    ...
                    columns: [
                      ...
                      GridColumn(
                        ...
                        label: const CustomColumnLabel('使用者名'),
                      ),
                      GridColumn(
                        columnName: 'shopUserEmail',
                        label: const CustomColumnLabel('使用者メールアドレス'),
                      ),
                      GridColumn(
                        columnName: 'shopUserTel',
                        label: const CustomColumnLabel('使用者電話番号'),
                      ),
                      GridColumn(
                        columnName: 'approval',
