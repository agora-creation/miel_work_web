...
class RequestOvertimeModel {
  ...
  String get workPeriod => _workPeriod;
  String get workContent => _workContent;
  String get remarks => _remarks;
  int get approval => _approval;
  DateTime get approvedAt => _approvedAt;
  DateTime get createdAt => _createdAt;

  RequestOvertimeModel.fromSnapshot(
    ...
    _workPeriod = data['workPeriod'] ?? '';
    _workContent = data['workContent'] ?? '';
